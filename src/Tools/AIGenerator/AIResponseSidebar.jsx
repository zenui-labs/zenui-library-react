...
const AIResponseSidebar = ({sidebarOpen, setSidebarOpen, codes, isGenerating}) => {
    ...
    return (
        <aside className={`${
            ...
            <p className='fixed bottom-8 left-[50%] transform translate-x-[-50%] text-center text-[0.9rem] bg-clip-text text-transparent bg-gradient-to-r from-[#0FABCA] from-30% to-[#CD00F1] opacity-80'>
                Powered by @ZenUI
            </p>
        </aside>
    );
