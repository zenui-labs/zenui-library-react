...
const ColorCodeCopyModal = ({isCopyClicked, setIsCopyClicked, clipboardColor}) => {
    ...
    return (
        <div
            ...
            } w-full h-screen fixed top-0 left-0 z-[999] bg-[#0000002a] transition-all duration-300 flex items-center justify-center`}
        >
            <div
                className={`${
            ...
            >
                <RxCross2
                    className='absolute top-3 right-3 p-2 dark:text-darkSubTextColor dark:hover:bg-slate-800 text-[2rem] hover:bg-gray-100 rounded-full cursor-pointer'
                    onClick={() => setIsCopyClicked(false)}/>
