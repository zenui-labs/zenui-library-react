...
const WarningMessageCard = ({children, text, width = 90}) => {
    return (
        <div
            className={`p-4 flex gap-3 w-full 425px:w-[${width}%] bg-yellow-50/50 dark:border-yellow-700/50 border border-yellow-300 rounded-normal mb-8 dark:bg-yellow-700/30`}>
            <p>
