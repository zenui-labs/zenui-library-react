    ...
    return (
        <div className='w-full'>
            <div className="flex gap-3 flex-wrap mb-10">
                <button
                    onClick={shuffle}
                    className="border-primary flex items-center gap-2 border bg-primary/20 hover:bg-primary/50 px-4 py-2 rounded-lg font-medium dark:bg-slate-900 dark:text-darkTextColor dark:border-slate-700 transition-colors"
                >
