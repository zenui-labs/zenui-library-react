...
const StarfieldWarpExample = () => {
    ...
    return (
        <div
            ref={wrapperRef}
            className="relative w-full h-[500px] overflow-hidden rounded-high bg-gray-900"
        >
            <canvas ref={canvasRef} className="absolute inset-0 w-full h-full"/>

            <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-center">
                <h1 className="text-4xl font-bold text-white md:text-6xl">Starfield Warp</h1>
                <p className="mt-4 text-lg text-white/70">
                    Move your mouse away from center to increase warp speed
                </p>
            </div>
        </div>
    );
