    ...
    return (
        <div className="relative w-full h-[500px] overflow-hidden rounded-high bg-gray-900">
            ...
            <div
                ...
                <h1 className="text-4xl font-bold text-white md:text-6xl">String Art</h1>
                <p className="mt-4 text-lg text-white/70">Move your mouse to create string patterns</p>
            </div>
        </div>
    )
}
