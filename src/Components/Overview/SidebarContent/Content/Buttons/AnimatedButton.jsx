...
<button className="relative px-6 py-3 font-bold text-white rounded-lg group">
  ...
  <span className="relative">ZenUI Library</span>
        ...
        <div className="mt-8">
          <ContentHeader text={"Day Night Toggle Animation"} id={"day_night_toggle_animation"}/>
        </div>

        <ComponentDescription text='A reusable button with a day-night toggle animation, switching between a sun with clouds and a moon with stars on click.'/>
