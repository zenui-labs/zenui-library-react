    ...
    return (
        <div className='w-full'>
            ...
            <div
                ...
                className="min-h-64 p-4 cursor-text border dark:border-slate-600 dark:text-slate-300 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
            />
