    ...
    return (
        <>
            <section className='px-6 1024px:px-12 py-10 overflow-hidden'>
                <img alt='zenui-hero/image' loading='lazy'
                ...
                <div className='w-full 1024px:max-w-[1000px] mx-auto mt-6'>
                    ...
                    <p className='text-[1rem] text-gray-700 mt-2 640px:mt-0.5 dark:text-darkSubTextColor'>Welcome to the
                        ...
                        whose efforts have significantly impacted the ZenUI Library and its community. Your dedication
                        to
                        improving ZenUI can earn you a spot among these exceptional individuals.</p>

                    <div className='mt-9'>
                        <h4 className='text-[1.5rem] font-semibold text-gray-900 dark:text-darkTextColor'>🌟 What is a
                            ZenUI
                            Hero?</h4>
                        <p className='text-[1rem] text-gray-700 mt-1 ml-2 dark:text-darkSubTextColor'>A <b>ZenUI
                            Hero</b> is
                            a title awarded to contributors
                            who go above and beyond in helping ZenUI grow,
                            solve critical issues, or make extensive contributions to the library. This recognition
                            reflects
                            your skill, commitment, and value as a community member.</p>
                    </div>

                    <div className='mt-9 relative'>
                        <h4 className='text-[1.5rem] font-semibold text-gray-900 dark:text-darkTextColor'>🛠️ How to
                            Become a
                            ZenUI Hero?</h4>
                        ...
                        <p className='text-[1rem] text-gray-700 ml-6 mt-1 dark:text-darkSubTextColor'>A critical issue
                            is a
                            problem that:</p>

                        <ul className='list-disc ml-14 mb-5 mt-4 text-gray-700 dark:text-darkSubTextColor flex flex-col gap-[8px]'>
                            <li>Breaks the <b>user experience</b> (e.g., navigation or features not working as
                                expected).
                            </li>
                        ...
                        <div
                            ...
                            <b>Example: Fixing a bug that causes a complete layout crash when resizing components.</b>
                        </div>

                        <p className='mt-9 font-semibold ml-2 text-[1.1rem] text-gray-900 dark:text-darkSubTextColor'>2.
                            Make Significant
                            Contributions</p>
                        <p className='text-[1rem] text-gray-700 dark:text-darkSubTextColor ml-6 mt-1'>If you haven't
                            tackled
                        ...
                        <ul className='list-disc mt-4 ml-14 mb-5 dark:text-darkSubTextColor text-gray-700 flex flex-col gap-[8px]'>
                            <li>Submitting <b>10-20+ meaningful contributions</b> to the library.( don't worry, if you
                                solved any critical issue and it's much critical or important for ZenUI Library you will
                                be
                    ...
                    <div className='mt-14'>
                        ...
                        <ul className='list-disc ml-14 mb-5 mt-2 text-gray-700 dark:text-darkSubTextColor flex flex-col gap-[8px]'>
                            <li>You must follow ZenUI’s <b className='underline'><a
                                ...
                                target='_blank' rel="noreferrer">code of conduct</a></b> and respect the community
                                guidelines.
                            </li>
                            ...
                            <li>Contributions should be made via the ZenUI Library's official <b
                                className='underline'><a
                                href='https://github.com/Asfak00/zenui-library' target='_blank' rel="noreferrer">GitHub
                                repository.</a></b>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className='mt-9'>
                        ...
                        <ul className='list-disc ml-14 mb-5 mt-2 dark:text-darkSubTextColor text-gray-700 flex flex-col gap-[8px]'>
                            <li>Your name and profile will be featured on the <b className='underline'><a
                                href='https://zenui.net/about-us' target='_blank' rel="noreferrer">ZenUI Heroes Wall of
                                Fame</a></b> on the
                                official
                    ...
                    <div className='mt-9'>
                        <h4 className='text-[1.5rem] font-semibold text-gray-900 dark:text-darkTextColor'>❓ Need
                            Help?</h4>
                        <p className='text-[1rem] text-gray-700 mt-1 ml-3 dark:text-darkSubTextColor'>If you have
                            questions
